<script lang="ts">
  ...
  let category = data.book?.category || '';
  let coverImage: File | null = null;
  let coverPreview: string | null = data.book?.coverImage || null;
  let loading = false;
  let error = '';
  ...
  <div class="flex">
    ...
    <div class="flex-1 bg-[#FAF9E4] min-h-screen px-8 py-6">
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-[#B5BD36]">Edit Book Details</h1>
      ...
      {#if form?.success}
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4" role="alert">
          <span class="block sm:inline">Book updated successfully!</span>
        </div>
      {/if}
      ...
      <div class="bg-white p-6 rounded-lg shadow-md">
        <form 
          ...
          use:enhance={({ formData }) => {
            ...
            // Make sure the file is included in the FormData if a new one was selected
            if (coverImage) {
          ...
          <div class="flex gap-6">
            <div class="w-1/3">
              <div class="bg-gray-100 aspect-[3/4] rounded flex items-center justify-center border-2 border-dashed border-gray-300 relative overflow-hidden">
                {#if coverPreview}
                  <img 
                    src={typeof coverPreview === 'string' && coverPreview.startsWith('data:') 
                      ? coverPreview 
            ...
            <div class="w-2/3 space-y-4 text-gray-800">
              ...
              <div>
                ...
                >
                  ...
                  <option value="NATURE & WILDLIFE" selected={category === 'NATURE & WILDLIFE'}>NATURE & WILDLIFE</option>
